                    ...
                    <div className="col-12">
                        <nav className="navbar navbar-expand-lg navbar-light p-0">
                            <div className="container-fluid">
                                ...
                                <a className="flex-shrink-0 navbar-brand p-0" target="_blank" rel="noreferrer" href="https://bitzen.space/">
                                    ...
                                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0 justify-content-center">
                                        <li className="nav-item">
                                            <a className="nav-link p-0" aria-current="page" target="_blank" rel="noreferrer"
                                                href="https://bitzen.space/">Home</a>
                                        </li>
                                        <li className="nav-item">
                                            <Link to="/" className={`nav-link p-0 ${router.pathname === "/" ? "active" : ""}`} >Stake</Link>
                                        </li>
                                        <li className="nav-item">
                        ...
                        {/* <!--MOBILE MENU--> */}
                        <div className="offcanvas offcanvas-start" style={{"background" : "#1f2128"}} tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                            <div className="offcanvas-header">
                                <a className="navbar-brand p-0" href="https://bitzen.space/" target="_blank" rel="noreferrer">
                                    <img src={logoBlack} style={{ "height": "70px" }} className="lazy" alt="logo-blkc" />
                                </a>
                            ...
                            <div className="offcanvas-body">
                                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                    <li className="nav-item">
                                        <a className="nav-link p-0" aria-current="page" target="_blank" rel="noreferrer" href="https://bitzen.space/">Home</a>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/" className={`nav-link p-0 ${router.pathname === "/" ? "active" : ""}`} >Stake</Link>
                                    </li>
